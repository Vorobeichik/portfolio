...
function flipCard() {
    scoreCount++;
    document.getElementById("score__now").innerHTML = "Очки:" + Math.floor(scoreCount/2);
    document.getElementById("score__result").innerHTML = "Ваши очки:" + " " + Math.floor(scoreCount/2) + "Ходов";
    if (scoreCount/2 <= 6) {
        document.getElementById("prize").innerHTML = "Ваш соц. рейтинг 20%";
        document.getElementById("benefit").innerHTML = randomOne() + "20" + randomString + codeDate;
    } else if (scoreCount/2 > 6 && scoreCount/2 <= 10) {
        document.getElementById("prize").innerHTML = "Ваш соц. рейтинг 15%";
